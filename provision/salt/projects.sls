...
load-project-{{ project }}:
  git.latest:
    ...
    {% if project_arg['force'] is defined and project_arg['force'] == 'True' %}- force: True{%- endif %} 
    - unless: cd /var/www/{{ project_arg['target'] }}/provision/salt/config  #maybe this shouldn't be at all?
    {% if project_arg['submodules'] is defined and project_arg['submodules'] == 'True' %}- submodules: True{%- endif %} 
    {% if project_arg['force_checkout'] is defined and project_arg['force_checkout'] == 'True' %}- force_checkout: True{%- endif %} 
    {% if project_arg['mirror'] is defined and project_arg['mirror'] == 'True' %}- mirror: True{%- endif %} 
    {% if project_arg['bare'] is defined and project_arg['bare'] == 'True' %}- bare: True{%- endif %} 
